...
need(){ [[ -f "$1" ]] || err "缺文件：$1"; }
need "$ROOT/docs/dev/design/$REPO.md"
need "$DIR/README.md"
need "$DIR/docs/手册.md"
need "$DIR/AGENTS.md"
need "$DIR/CLAUDE.md"
...
# 设计计划九问
[[ "$(grep -c '^## ' "$ROOT/docs/dev/design/$REPO.md")" -ge 9 ]] \
  || err "docs/dev/design/$REPO.md 的九个二级标题不齐"

for f in "$ROOT/docs/dev/design/$REPO.md" "$DIR/README.md" "$DIR/docs/手册.md" "$DIR/AGENTS.md"; do
