...
| **部署人员** | 装什么、什么顺序、哪些自动哪些要我做、报错了怎么办 | [English](ops/en/deployment-handbook.md) · [中文](ops/zh/deployment-handbook.md) ⭐ **只需要这一份**（该部署哪种拓扑/环境，看它引导去的 [选型指南](ops/zh/deployment-selection-guide.md)） |
| **开发者**（写组件的人） | 怎么写一个组件、测试写在哪一层、卡住了怎么办 | [`standards/zh/00-master-guide.md`](standards/zh/00-master-guide.md)（[English](standards/en/00-master-guide.md)）的 **§4 SOP-W** → 该组件的 [`design/zh/<仓库名>.md`](design/zh/)；**测试怎么分层/怎么跑/卡住了怎么办**，唯一真相源是 [`standards/zh/04-testing-standard.md`](standards/zh/04-testing-standard.md)；**种子数据/测试数据怎么设计、组件间数据怎么协作**，唯一真相源是 [`standards/zh/05-data-construction-standard.md`](standards/zh/05-data-construction-standard.md)；「这个坑是不是已经踩过了」先查 [`dev/field-tested-pitfalls-log.zh.md`](dev/field-tested-pitfalls-log.zh.md)；日常怎么聚焦到几个组件、提交前要注意什么见 [`arsenal-maintenance-handbook.zh.md`](arsenal-maintenance-handbook.zh.md) |
...
**文档本身该怎么组织、什么时候该拆成独立文件、组件文档要同时服务哪两种读者、面向最终用户的文档怎么做双语**，规则见 [`standards/zh/01-documentation-standard.md`](standards/zh/01-documentation-standard.md)（[English](standards/en/01-documentation-standard.md)）。
...
写组件时看 [`standards/zh/00-master-guide.md`](standards/zh/00-master-guide.md) 的 **SOP-D**，四份缺一不可：

| # | 文件 | 在哪 | 给谁看 |
|---|---|---|---|
| 1 | `docs/design/zh/<仓库名>.md` | **本仓库** | 做设计决策的人。跨组件对照着看 |
