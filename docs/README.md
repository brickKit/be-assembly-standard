...
| # | 文件 | 在哪 | 给谁看 |
|---|---|---|---|
| 1 | `docs/dev/design/<仓库名>.md` | **本仓库** | 做设计决策的人。跨组件对照着看 |
